...
<head>
    <meta charset="utf-8">
    <title>Женское | Brand Nest</title>
...
<div class="main_container">
    <section class="container my-4">
        <h4 class="text-center">Женское</h4>
        ...
        <div class="modal-content">
            <form id="addToCartForm" method="post" action="cart.php">
                ...
                <div class="modal-body">
                    ...
                    <p class="text-danger fw-bold" id="productModalPrice"></p>
                    <label for="sizeSelect">Выберите размер:</label>
                    <select id="sizeSelect" class="form-select mb-3" name="size">
...
<script>
    ...
    fetch('get_women_products.php')
        .then(response => response.json())
        .then(data => {
            products = data.map(product => ({
                ...product,
                imgSrc: product.image_url // для совместимости с displayProducts
            }));
    ...
    function displayProducts(products) {
        ...
        products.forEach(product => {
          ...
          <div class="col-md-3 col-sm-6 col-12">
            <div class="card text-center h-100" data-id="${product.id}" style="cursor: pointer;">
              <img src="${product.imgSrc}" class="card-img-top" alt="${product.title}" style="height:250px;object-fit:cover;">
    ...
    function showProductModal(productId) {
        ...
        if (product) {
            ...
            document.getElementById('productModalImage').src = product.imgSrc;
